...
/**
 * 直接输出 schema.org JSON-LD script 节点。
 * 同时支持 server / client 渲染（无 hooks / 无 browser API）。
 * 多个实例并存时各自渲染独立 <script>，不会互相覆盖。
 */
  ...
  switch (type) {
    ...
    case 'organization':
      jsonLd = {
        ...
        sameAs: ['https://github.com/linx', 'https://twitter.com/linx'],
      }
      break
  }
